...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Sky1218', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '懶得打自己介', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://sky@sky1218.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Sky, 博客', // 网站关键词 英文逗号隔开
